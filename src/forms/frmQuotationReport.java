...
public class frmQuotationReport extends javax.swing.JFrame {
ResultSet rs;
...
String tblClick;
    public frmQuotationReport() {
        ...
        doConnect();
        fillTable();
        setDefaultCloseOperation(frmQuotationReport.DISPOSE_ON_CLOSE);
...
//        conn = DriverManager.getConnection("jdbc:mysql://192.168.1.13/dbticketing","iSoft","iSoft123");
    ...
    private void initComponents() {
        ...
        jLabel6.setText("QUOTATION REPORTS");
        ...
        jScrollPane1.setViewportView(tblQuote);
    ...
    private void sortTable(){
        tblQuote.getColumnModel().getColumn(0).setHeaderValue("ID");
        tblQuote.getColumnModel().getColumn(1).setHeaderValue("DATE");
        tblQuote.getColumnModel().getColumn(2).setHeaderValue("CONTACT PERSON");
        tblQuote.getColumnModel().getColumn(3).setHeaderValue("COMPANY");
        tblQuote.getColumnModel().getColumn(4).setHeaderValue("INVOICE AMOUNT");
    }
    private void fillTable(){
        try{
            pstmt = conn.prepareStatement("Select qg_id,qg_quotedate,qg_clientName,qg_clientCompany,"
                    + "qg_totalinvoiceamount from tblQuoteGenerator order by qg_id DESC");
            rs = pstmt.executeQuery();
            tblQuote.setModel(DbUtils.resultSetToTableModel(rs));
            pstmt.close();
            sortTable();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try{
            pstmt = conn.prepareStatement("Select qg_id,qg_quotedate,qg_clientName,qg_clientCompany,"
                    + "qg_totalinvoiceamount, from tblQuoteGenerator where qg_quotedate between ? and ?");
            rs = pstmt.executeQuery();
            tblQuote.setModel(DbUtils.resultSetToTableModel(rs));
            pstmt.close();
            sortTable();
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try{
            ...
            //            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/dbticketing","root","root");
            conn = DriverManager.getConnection("jdbc:mysql://192.168.100.2/dbticketing","iSoft","iSoft123");
            JasperDesign jd = JRXmlLoader.load(new File("src\\reports\\repQuoteSelect.jrxml"));
    ...
    private void tblQuoteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblQuoteMouseClicked
        ...
        tblClick = tblQuote.getModel().getValueAt(ba, 0).toString();
        System.out.println("add " + tblClick);
//        String fetchData ="Select * from tblQuoteGenerator where qg_id=?";
//        try{
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmQuotationReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmQuotationReport().setVisible(true);
            }
        });
    }
