...
String tblClick;
    public frmInvoiceReport() {
        ...
        doConnect();
        fillTable();
        setDefaultCloseOperation(frmInvoiceReport.DISPOSE_ON_CLOSE);
...
//        conn = DriverManager.getConnection("jdbc:mysql://192.168.1.13/dbticketing","iSoft","iSoft123");
    ...
    private void fillTable(){
        try{
            pstmt = conn.prepareStatement("Select ig_id,ig_quotedate,ig_clientName,ig_clientCompany,"
                    + "ig_totalinvoiceamount from tblInvoiceGenerator order by ig_id DESC");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try{
            pstmt = conn.prepareStatement("Select ig_id,ig_quotedate,ig_clientName,ig_clientCompany,"
                    + "ig_totalinvoiceamount, from tblInvoiceGenerator where ig_quotedate between ? and ?");
            rs = pstmt.executeQuery();
            tblInvoice.setModel(DbUtils.resultSetToTableModel(rs));
            pstmt.close();
            sortTable();
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try{
            ...
            //            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/dbticketing","root","root");
            conn = DriverManager.getConnection("jdbc:mysql://192.168.100.2/dbticketing","iSoft","iSoft123");
            JasperDesign jd = JRXmlLoader.load(new File("src\\reports\\repInvoiceSelect.jrxml"));
...
//        String fetchData ="Select * from tblQuoteGenerator where ig_id=?";
//        try{
