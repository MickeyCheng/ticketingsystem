...
public class frmQuoteGeneration extends javax.swing.JFrame {
ResultSet rs;
Connection conn;
...
//        conn = DriverManager.getConnection("jdbc:mysql://192.168.1.13/dbticketing","iSoft","iSoft123");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("QUOTE GENERATOR");
    ...
    private void getNextQuoteID(){
        try{
            pstmt = conn.prepareStatement("SELECT * from tblQuoteGenerator order by qg_id DESC LIMIT 1");
            rs = pstmt.executeQuery();
            if (rs.next()){
                getMaxQuoteID = rs.getInt("qg_id");
                getMaxQuoteID++;
            }else{
                getMaxQuoteID=1;
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        getNextQuoteID();
        String insertQuote = "INSERT INTO tblQuoteGenerator (qg_id,qg_clientName,qg_clientCompany,qg_clientAddress,"
                + "qg_clientContact,qg_clientEmail,qg_itemCode,qg_itemName,qg_quantity,qg_price,"
                + "qg_totalPrice,qg_totalQuantity,qg_totalInvoiceAmount,qg_quoteDate)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            for(int i=0; i<tblQuote.getRowCount();i++){
    ...
    private void printQuote(){
            ...
            try{
                ...
                Class.forName("com.mysql.jdbc.Driver");
                conn = DriverManager.getConnection("jdbc:mysql://192.168.100.2/dbticketing","iSoft","iSoft123");
                JasperDesign jd = JRXmlLoader.load(new File("src\\Reports\\repQuote.jrxml"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmQuoteGeneration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmQuoteGeneration().setVisible(true);
            }
        });
    }
